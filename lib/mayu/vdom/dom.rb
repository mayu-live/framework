...
module Mayu
  module VDOM
    class DOM
      ...
      class DOMException < StandardError ; end
      ...
      class CSSStyleDeclaration
        ...
        sig {params(name: String, value: T.any(String, Integer, Float)).returns(self)}
      ...
      class Node
        ...
        sig {params(new_parent: T.nilable(Element)).returns(T.nilable(Element))}
        ...
        sig {params(new_node: Node, reference_node: T.nilable(Node)).returns(self)}
