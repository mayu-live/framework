...
Gem::Specification.new do |spec|
  ...
  # Klenod platform
  spec.add_dependency "klenod-build", "= 0.0.8"
  spec.add_dependency "klenod-runtime", "= 0.0.8"
  spec.add_dependency "klenod-rack", "= 0.0.8"
  spec.add_dependency "klenod-plugin-css", "= 0.0.8"
  spec.add_dependency "klenod-plugin-javascript", "= 0.0.8"
