...
class Temple::Generator
  ...
  # @api public
  #
  # source://temple//lib/temple/generator.rb#90
  def concat(str); end
end
...
class Temple::Generators::RailsOutputBuffer < ::Temple::Generators::StringBuffer
  ...
  # @api public
  #
  # source://temple//lib/temple/generators/rails_output_buffer.rb#26
  def concat(str); end
...
module Temple::Utils
  ...
  #
  # source://temple//lib/temple/utils.rb#64
  ...
  #
  # source://temple//lib/temple/utils.rb#25
  ...
  # @api public
  #
  # source://temple//lib/temple/utils.rb#75
  ...
  #
  # source://temple//lib/temple/utils.rb#54
