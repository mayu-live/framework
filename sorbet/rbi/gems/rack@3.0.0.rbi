...
#
# source://rack//lib/rack/query_parser.rb#3
module Rack
  class << self
...
class Rack::Builder
  ...
  #
  # source://rack//lib/rack/builder.rb#114
  ...
  #
  # source://rack//lib/rack/builder.rb#261
  def call(env); end

  # Freeze the app (set using run) and all middleware instances when building the application
  # in to_app.
  #
  # source://rack//lib/rack/builder.rb#244
  def freeze_app; end
  ...
  # outside the block.
  #
  # source://rack//lib/rack/builder.rb#237
  ...
  # @raise [ArgumentError]
  #
  # source://rack//lib/rack/builder.rb#192
  def run(app = T.unsafe(nil), &block); end

  # Return the Rack application generated by this instance.
  #
  # source://rack//lib/rack/builder.rb#249
  def to_app; end
  ...
  #
  # source://rack//lib/rack/builder.rb#149
  ...
  #   run MyApp
  #
  # source://rack//lib/rack/builder.rb#208
  ...
  #
  # source://rack//lib/rack/builder.rb#269
  ...
  class << self
    ...
    # generated from it.
    #
    # source://rack//lib/rack/builder.rb#126
...
class Rack::Lint::Wrapper
  ...
  # @raise [LintError]
  #
  # source://rack//lib/rack/lint.rb#849
  def call(stream); end
  ...
  # +close+.
  #
  # source://rack//lib/rack/lint.rb#836
  def to_ary; end
...
#
# source://rack//lib/rack/lint.rb#877
...
#
# source://rack//lib/rack/multipart/parser.rb#17
...
class Rack::Multipart::Parser
  ...
  #
  # source://rack//lib/rack/multipart/parser.rb#193
  ...
  # source://rack//lib/rack/multipart/parser.rb#278
  def handle_consume_token; end

  # source://rack//lib/rack/multipart/parser.rb#415
  ...
  # source://rack//lib/rack/multipart/parser.rb#311
  def handle_mime_body; end

  # source://rack//lib/rack/multipart/parser.rb#288
  def handle_mime_head; end

  # source://rack//lib/rack/multipart/parser.rb#249
  def read_data(io, outbuf); end

  # source://rack//lib/rack/multipart/parser.rb#381
...
class Rack::Multipart::Parser::BoundedIO
  ...
  #
  # source://rack//lib/rack/multipart/parser.rb#52
  def initialize(io, content_length); end

  # source://rack//lib/rack/multipart/parser.rb#58
  def read(size, outbuf = T.unsafe(nil)); end
end

# source://rack//lib/rack/multipart/parser.rb#378
...
class Rack::Multipart::Parser::Collector
  ...
  # source://rack//lib/rack/multipart/parser.rb#181
...
# source://rack//lib/rack/multipart/parser.rb#81
...
class Rack::QueryParser
  ...
  #
  # source://rack//lib/rack/query_parser.rb#93
  ...
  # case.
  #
  # source://rack//lib/rack/query_parser.rb#72
  ...
  # (which defaults to '&').
  #
  # source://rack//lib/rack/query_parser.rb#44
...
#
# source://rack//lib/rack/query_parser.rb#19
...
module Rack::Request::Helpers
  ...
  # source://rack//lib/rack/request.rb#576
  def accept_encoding; end

  # source://rack//lib/rack/request.rb#580
  ...
  # source://rack//lib/rack/request.rb#572
  def fullpath; end
  ...
  # Note that modifications will not be persisted in the env. Use update_param or delete_param if you want to destructively modify params.
  #
  # source://rack//lib/rack/request.rb#525
  def params; end
  ...
  # <tt>env['rack.input']</tt> is not touched.
  #
  # source://rack//lib/rack/request.rb#534
  def update_param(k, v); end
  ...
  # like Hash#values_at
  #
  # source://rack//lib/rack/request.rb#605
  def values_at(*keys); end
  ...
  # source://rack//lib/rack/request.rb#713
  ...
  # source://rack//lib/rack/request.rb#627
  def parse_http_accept_header(header); end

  # source://rack//lib/rack/request.rb#651
  def parse_multipart; end

  # source://rack//lib/rack/request.rb#647
  def parse_query(qs, d = T.unsafe(nil)); end

  # source://rack//lib/rack/request.rb#643
  def query_parser; end

  # source://rack//lib/rack/request.rb#704
  def reject_trusted_ip_addresses(ip_addresses); end

  # source://rack//lib/rack/request.rb#698
  def split_authority(authority); end

  # source://rack//lib/rack/request.rb#655
  ...
  # source://rack//lib/rack/request.rb#745
  def x_forwarded_proto_priority; end
end
...
# source://rack//lib/rack/request.rb#708
...
class Rack::Response
  ...
  # @raise [ArgumentError]
  #
  # source://rack//lib/rack/response.rb#162
  def []=(key, value); end
  ...
  # @raise [ArgumentError]
  #
  # source://rack//lib/rack/response.rb#166
  ...
  #
  # source://rack//lib/rack/response.rb#108
...
# source://rack//lib/rack/response.rb#174
module Rack::Response::Helpers
  ...
  # @raise [ArgumentError]
  #
  # source://rack//lib/rack/response.rb#213
  ...
  # source://rack//lib/rack/response.rb#284
  def cache_control; end

  # source://rack//lib/rack/response.rb#288
  ...
  # source://rack//lib/rack/response.rb#251
  def content_length; end

  # Get the content type of the response.
  #
  # source://rack//lib/rack/response.rb#234
  def content_type; end
  ...
  # source://rack//lib/rack/response.rb#268
  ...
  # source://rack//lib/rack/response.rb#308
  def etag; end
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/response.rb#175
  def invalid?; end

  # source://rack//lib/rack/response.rb#256
  def location; end

  # source://rack//lib/rack/response.rb#260
  def location=(location); end

  # source://rack//lib/rack/response.rb#243
  def media_type; end

  # source://rack//lib/rack/response.rb#247
  def media_type_params; end
  ...
  # source://rack//lib/rack/response.rb#264
  def set_cookie(key, value); end

  # source://rack//lib/rack/response.rb#276
  def set_cookie_header; end

  # source://rack//lib/rack/response.rb#280
  ...
  # source://rack//lib/rack/response.rb#346
...
# source://rack//lib/rack/response.rb#360
class Rack::Response::Raw
  include ::Rack::Response::Helpers

  # @return [Raw] a new instance of Raw
  #
  # source://rack//lib/rack/response.rb#366
  def initialize(status, headers); end

  # source://rack//lib/rack/response.rb#383
  def delete_header(key); end
  ...
  # Returns the value of attribute headers.
  #
  # source://rack//lib/rack/response.rb#363
  def headers; end
  ...
  # Returns the value of attribute status.
  #
  # source://rack//lib/rack/response.rb#364
  def status; end
...
module Rack::Utils
  ...
  # is arbitrary.
  #
  # source://rack//lib/rack/utils.rb#162
  ...
  # :nocov:
  #
  # source://rack//lib/rack/utils.rb#87
  def clock_time; end

  # source://rack//lib/rack/utils.rb#372
  ...
  # source://rack//lib/rack/utils.rb#134
  ...
  # source://rack//lib/rack/utils.rb#637
...
# source://rack//lib/rack/utils.rb#175
...
#
# source://rack//lib/rack/utils.rb#537
...
# @api private
#
# source://rack//lib/rack/utils.rb#508
...
# source://rack//lib/rack/utils.rb#635
