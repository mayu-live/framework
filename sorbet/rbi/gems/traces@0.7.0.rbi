...
# source://traces//lib/traces/backend.rb#23
module Traces
  class << self
    # Extend the specified class in order to emit traces.
    #
    # source://traces//lib/traces/provider.rb#57
    def Provider(klass, &block); end

    # @return [Boolean]
    #
    # source://traces//lib/traces/provider.rb#27
    def enabled?; end

    # Require a specific trace backend.
    #
    # source://traces//lib/traces/backend.rb#25
    def require_backend(env = T.unsafe(nil)); end
  end
end

# source://traces//lib/traces/provider.rb#31
module Traces::Provider; end

# source://traces//lib/traces/provider.rb#34
module Traces::Singleton
  # A module which contains tracing specific wrappers.
  #
  # source://traces//lib/traces/provider.rb#36
