...
# source://async-io//lib/async/io/generic.rb#26
module Async; end
...
module Async::IO
  class << self
    # @return [Boolean]
    #
    # source://async-io//lib/async/io.rb#38
    def buffer?; end

    # source://async-io//lib/async/io.rb#34
...
# source://async-io//lib/async/io/composite_endpoint.rb#27
class Async::IO::CompositeEndpoint < ::Async::IO::Endpoint
  # @return [CompositeEndpoint] a new instance of CompositeEndpoint
  #
  # source://async-io//lib/async/io/composite_endpoint.rb#28
  def initialize(endpoints, **options); end

  # source://async-io//lib/async/io/composite_endpoint.rb#50
  def bind(&block); end

  # source://async-io//lib/async/io/composite_endpoint.rb#37
  def connect(&block); end
...
class Async::IO::Endpoint
  ...
  class << self
    # source://async-io//lib/async/io/composite_endpoint.rb#56
    def composite(*endpoints, **options); end

    # Generate a list of endpoints from an array.
    #
    # source://async-io//lib/async/io/endpoint/each.rb#47
    ...
    # source://async-io//lib/async/io/socket_endpoint.rb#68
    ...
    # source://async-io//lib/async/io/endpoint/each.rb#30
    ...
    # @return [UNIXEndpoint]
    #
    # source://async-io//lib/async/io/unix_endpoint.rb#69
...
#
# source://async-io//lib/async/io/notification.rb#28
class Async::IO::Notification
  # @return [Notification] a new instance of Notification
  #
  # source://async-io//lib/async/io/notification.rb#29
  def initialize; end

  # source://async-io//lib/async/io/notification.rb#37
  def close; end
  ...
  # @return [void]
  #
  # source://async-io//lib/async/io/notification.rb#54
  def signal; end
  ...
  # @return [Object]
  #
  # source://async-io//lib/async/io/notification.rb#44
  def wait; end
end
...
#
# source://async-io//lib/async/io/ssl_socket.rb#106
class Async::IO::SSLServer
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#118
  def dup; end
...
class Async::IO::SharedEndpoint < ::Async::IO::Endpoint
  ...
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#57
  def initialize(endpoint, wrappers, **options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#125
  def accept(backlog = T.unsafe(nil), &block); end

  # source://async-io//lib/async/io/shared_endpoint.rb#89
  def bind; end

  # Close all the internal wrappers.
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#84
  def close; end

  # source://async-io//lib/async/io/shared_endpoint.rb#107
  def connect; end

  # Returns the value of attribute endpoint.
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#64
  def endpoint; end

  # source://async-io//lib/async/io/shared_endpoint.rb#67
  def local_address_endpoint(**options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#75
  def remote_address_endpoint(**options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#131
  def to_s; end

  # Returns the value of attribute wrappers.
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#65
  def wrappers; end

  class << self
    # Create a new `SharedEndpoint` by binding to the given endpoint.
    #
    # source://async-io//lib/async/io/shared_endpoint.rb#31
    ...
    #
    # source://async-io//lib/async/io/shared_endpoint.rb#48
...
#
# source://async-io//lib/async/io/socket_endpoint.rb#28
class Async::IO::SocketEndpoint < ::Async::IO::Endpoint
  # @return [SocketEndpoint] a new instance of SocketEndpoint
  #
  # source://async-io//lib/async/io/socket_endpoint.rb#29
  def initialize(socket, **options); end

  # source://async-io//lib/async/io/socket_endpoint.rb#42
  def bind(&block); end

  # source://async-io//lib/async/io/socket_endpoint.rb#54
  def connect(&block); end

  # Returns the value of attribute socket.
  #
  # source://async-io//lib/async/io/socket_endpoint.rb#40
  def socket; end

  # source://async-io//lib/async/io/socket_endpoint.rb#36
  def to_s; end
end
...
class Async::IO::Stream
  ...
  #
  # source://async-io//lib/async/io/stream.rb#183
  def <<(string); end
  ...
  # source://async-io//lib/async/io/stream.rb#205
  def close_read; end

  # source://async-io//lib/async/io/stream.rb#209
  def close_write; end

  # @return [Boolean]
  #
  # source://async-io//lib/async/io/stream.rb#201
  def closed?; end

  # @return [Boolean]
  #
  # source://async-io//lib/async/io/stream.rb#197
  def connected?; end
  ...
  # @return [Boolean]
  #
  # source://async-io//lib/async/io/stream.rb#229
  def eof; end

  # @raise [EOFError]
  #
  # source://async-io//lib/async/io/stream.rb#241
  def eof!; end
  ...
  #
  # source://async-io//lib/async/io/stream.rb#152
  def flush; end

  # source://async-io//lib/async/io/stream.rb#147
  ...
  # source://async-io//lib/async/io/stream.rb#141
  def peek; end

  # source://async-io//lib/async/io/stream.rb#189
  ...
  #
  # source://async-io//lib/async/io/stream.rb#122
  ...
  #
  # source://async-io//lib/async/io/stream.rb#172
  ...
  #
  # source://async-io//lib/async/io/stream.rb#281
  def consume_read_buffer(size = T.unsafe(nil)); end

  # Fills the buffer from the underlying stream.
  #
  # source://async-io//lib/async/io/stream.rb#251
...
class Async::IO::Trap
  ...
  #
  # source://async-io//lib/async/io/trap.rb#44
  def ignore!; end
  ...
  #
  # source://async-io//lib/async/io/trap.rb#54
  def install!; end

  # source://async-io//lib/async/io/trap.rb#39
  def to_s; end
  ...
  #
  # source://async-io//lib/async/io/trap.rb#70
  ...
  # @return [void]
  #
  # source://async-io//lib/async/io/trap.rb#103
...
#
# source://async-io//lib/async/io/unix_endpoint.rb#28
class Async::IO::UNIXEndpoint < ::Async::IO::AddressEndpoint
  # @return [UNIXEndpoint] a new instance of UNIXEndpoint
  #
  # source://async-io//lib/async/io/unix_endpoint.rb#29
  def initialize(path, type, **options); end

  # source://async-io//lib/async/io/unix_endpoint.rb#50
  def bind(&block); end

  # @return [Boolean]
  #
  # source://async-io//lib/async/io/unix_endpoint.rb#42
  def bound?; end

  # Returns the value of attribute path.
  #
  # source://async-io//lib/async/io/unix_endpoint.rb#40
  def path; end

  # source://async-io//lib/async/io/unix_endpoint.rb#36
  def to_s; end
end
