...
class Protocol::HTTP::Middleware::Builder
  def initialize(default_app = nil); end
  def run(app); end
  def to_app; end
  def use(middleware, *arguments, **, &block); end
end
...
class Protocol::HTTP::Body::ZStream < Protocol::HTTP::Body::Wrapper
  ...
  def ratio; end
  def self.encoding_name(window_size); end
end
class Protocol::HTTP::Body::Deflate < Protocol::HTTP::Body::ZStream
  def read; end
  def self.for(body, window_size = nil, level = nil); end
end
class Protocol::HTTP::ContentEncoding < Protocol::HTTP::Middleware
  def call(request); end
  def initialize(app, content_types = nil, wrappers = nil); end
end
...
class Protocol::HTTP::Body::Digestable < Protocol::HTTP::Body::Wrapper
  def digest; end
  def etag; end
  def initialize(body, digest = nil, callback = nil); end
  def read; end
  def self.wrap(message, digest = nil, &block); end
end
class Protocol::HTTP::Body::File < Protocol::HTTP::Body::Readable
  def close(error = nil); end
  def empty?; end
  def file; end
  def initialize(file, range = nil, size: nil, block_size: nil); end
  def inspect; end
  def join; end
  def length; end
  def offset; end
