...
# source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:4
module Rack
  class << self
...
# source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:5
class Rack::RubyProf
  # @return [RubyProf] a new instance of RubyProf
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:6
  def initialize(app, options = T.unsafe(nil)); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:23
  def call(env); end
  ...
  # @return [Boolean]
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:52
  def paths_match?(path, paths); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:74
  def print(data, path); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:56
  def profiling_options; end

  # @return [Boolean]
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/rack.rb:46
...
# :enddoc:
#
# source://ruby-prof-1.4.3/lib/ruby-prof/version.rb:1
module RubyProf
  class << self
    # @raise [RuntimeError]
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:96
    def ensure_not_running!; end

    # @raise [RuntimeError]
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:92
    def ensure_running!; end

    # Returns the threads that ruby-prof should exclude from profiling
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:32
    def exclude_threads; end

    # Specifies which threads ruby-prof should exclude from profiling
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:37
    def exclude_threads=(value); end

    # Checks if the user specified the clock mode via
    # the RUBY_PROF_MEASURE_MODE environment variable
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof.rb:36
    ...
    # * RubyProf::MEMORY
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:14
    ...
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:27
    def measure_mode=(value); end

    # Pauses profiling
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:49
    def pause; end

    # Profiles a block
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:78
    def profile(options = T.unsafe(nil), &block); end

    # Resume profiling
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:64
    def resume; end
    ...
    # @return [Boolean]
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:55
    def running?; end

    # Starts profiling
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:42
    def start; end

    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:85
    def start_script(script); end

    # Stops profiling
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/compatibility.rb:70
    def stop; end
  end
end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:5
class RubyProf::AbstractPrinter
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:15
  def initialize(result); end

  # Returns the method to filter methods by (when using min_percent and max_percent)
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:31
  def filter_by; end

  # Returns the max_percent of time a method can take to be included in a profiling report
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:26
  def max_percent; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:80
  def method_href(thread, method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:74
  def method_location(method); end

  # Returns the min_percent of time a method must take to be included in a profiling report
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:21
  def min_percent; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:84
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:63
  def print(output = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:111
  def print_column_headers; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:114
  def print_footer(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:101
  def print_header(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:95
  def print_thread(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:89
  def print_threads; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:70
  def setup_options(options = T.unsafe(nil)); end

  # Returns how profile data should be sorted
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:41
  def sort_method; end

  # Returns the time format used to show when a profile was run
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:36
  def time_format; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/printers/abstract_printer.rb:7
    def needs_dir?; end
  end
end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_info_printer.rb:16
class RubyProf::CallInfoPrinter < ::RubyProf::AbstractPrinter
  private

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_info_printer.rb:49
  def print_footer(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_info_printer.rb:21
  def print_header(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_info_printer.rb:30
  def print_methods(thread); end
end

# source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_info_printer.rb:17
...
#   printer.print(STDOUT)
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:21
class RubyProf::CallStackPrinter < ::RubyProf::AbstractPrinter
  include ::ERB::Util

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:149
  def application; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:153
  def arguments; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:169
  def base64_image; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:136
  def color(p); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:132
  def dump(ci); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:165
  def expansion; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:114
  def graph_link(call_tree); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:104
  def link(method, recursive); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:120
  def method_href(method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:99
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:47
  def print(output = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:58
  def print_stack(output, visited, call_tree, parent_time); end

  # :enddoc:
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:53
  def setup_options(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:128
  def sum(a); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:176
  def template; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:161
  def threshold; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:157
  def title; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_stack_printer.rb:124
...
class RubyProf::CallTree
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:10
  def called; end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:30
  def children_time; end

  def depth; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:53
  def inspect; end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:20
  def self_time; end

  def source_file; end
  def target; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:49
  def to_s; end

  # The total time resulting from the parent method calling the target method
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:15
  def total_time; end

  # The wait time (of the parent) resulting from the parent method calling the target method
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree.rb:25
  def wait_time; end
end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:11
class RubyProf::CallTreePrinter < ::RubyProf::AbstractPrinter
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:103
  def base_name; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:12
  def calltree_name(method_info); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:78
  def convert(value); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:28
  def determine_event_specification_and_value_scale; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:82
  def file(method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:113
  def file_name_for_thread(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:121
  def file_path_for_thread(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:95
  def path; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:54
  def print(options = T.unsafe(nil)); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:125
  def print_headers(output, thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:131
  def print_method(output, method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:86
  def print_thread(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:69
  def print_threads; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:107
  def remove_subsidiary_files_from_previous_profile_runs; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:61
  def validate_print_params(options); end

  class << self
    # @return [Boolean]
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/printers/call_tree_printer.rb:99
    def needs_dir?; end
  end
end
...
#   puts method_names
#
# source://ruby-prof-1.4.3/lib/ruby-prof/call_tree_visitor.rb:17
class RubyProf::CallTreeVisitor
  # @return [CallTreeVisitor] a new instance of CallTreeVisitor
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree_visitor.rb:18
  def initialize(call_tree); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree_visitor.rb:22
  def visit(&block); end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/call_tree_visitor.rb:28
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:22
class RubyProf::DotPrinter < ::RubyProf::AbstractPrinter
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:27
  def initialize(result); end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:45
  def print(output = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:78
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:62
  def mode_name; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:95
  def print_classes(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:116
  def print_edges(total_time, method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:82
  def print_thread(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:66
  def print_threads; end

  # Silly little helper for printing to the @output
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:127
  def puts(str); end
end

# source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:23
RubyProf::DotPrinter::CLASS_COLOR = T.let(T.unsafe(nil), String)

# source://ruby-prof-1.4.3/lib/ruby-prof/printers/dot_printer.rb:24
RubyProf::DotPrinter::EDGE_COLOR = T.let(T.unsafe(nil), String)

# source://ruby-prof-1.4.3/lib/ruby-prof/exclude_common_methods.rb:5
module RubyProf::ExcludeCommonMethods
  class << self
    # source://ruby-prof-1.4.3/lib/ruby-prof/exclude_common_methods.rb:8
    def apply!(profile); end

    # source://ruby-prof-1.4.3/lib/ruby-prof/exclude_common_methods.rb:185
    def exclude_enumerable(profile, mod, *method_or_methods); end

    # source://ruby-prof-1.4.3/lib/ruby-prof/exclude_common_methods.rb:190
    def exclude_methods(profile, mod, *method_or_methods); end

    # source://ruby-prof-1.4.3/lib/ruby-prof/exclude_common_methods.rb:194
    def exclude_singleton_methods(profile, mod, *method_or_methods); end
  end
end

# source://ruby-prof-1.4.3/lib/ruby-prof/exclude_common_methods.rb:6
...
#   printer.print(STDOUT, {})
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/flat_printer.rb:15
class RubyProf::FlatPrinter < ::RubyProf::AbstractPrinter
  # Override for this printer to sort by self time by default
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/flat_printer.rb:16
  def sort_method; end

  private

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/flat_printer.rb:22
  def print_column_headers; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/flat_printer.rb:26
  def print_methods(thread); end
end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:18
class RubyProf::GraphHtmlPrinter < ::RubyProf::AbstractPrinter
  ...
  # printed out.
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:35
  def create_link(thread, overall_time, method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:50
  def file_link(path, linenum); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:46
  def method_href(thread, method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:26
  def print(output = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:21
  def setup_options(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_html_printer.rb:59
  def template; end
end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:16
class RubyProf::GraphPrinter < ::RubyProf::AbstractPrinter
  private

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:95
  def print_children(method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:27
  def print_header(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:48
  def print_methods(thread); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:80
  def print_parents(thread, method); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:23
  def sort_method; end
end

# source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:19
RubyProf::GraphPrinter::CALL_WIDTH = T.let(T.unsafe(nil), Integer)

# source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:17
RubyProf::GraphPrinter::PERCENTAGE_WIDTH = T.let(T.unsafe(nil), Integer)

# source://ruby-prof-1.4.3/lib/ruby-prof/printers/graph_printer.rb:18
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/measurement.rb:4
class RubyProf::Measurement
  ...
  # source://ruby-prof-1.4.3/lib/ruby-prof/measurement.rb:5
  def children_time; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/measurement.rb:13
  def inspect; end

  def self_time; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/measurement.rb:9
  def to_s; end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:6
class RubyProf::MethodInfo
  include ::Comparable

  # :enddoc:
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:56
  def <=>(other); end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:31
  def called; end

  # The time this method's children took to execute
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:51
  def children_time; end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:15
  def full_name; end
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:41
  def self_time; end

  def source_file; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:74
  def to_s; end

  # The total time this method took - includes self time + wait time + child time
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:36
  def total_time; end

  # The time this method waited for other fibers/threads to execute
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/method_info.rb:46
  def wait_time; end
end
...
#
# source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:7
class RubyProf::MultiPrinter
  # @return [MultiPrinter] a new instance of MultiPrinter
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:8
  def initialize(result, printers = T.unsafe(nil)); end

  # the name of the callinfo profile file
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:60
  def call_info_report; end

  # the name of the call stack profile file
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:75
  def dot_report; end

  # the name of the flat profile file
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:46
  def flat_report; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:55
  def graph_html_report; end

  # the name of the graph profile file
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:51
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:28
  def print(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:97
  def print_to_call_info(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:113
  def print_to_dot(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:79
  def print_to_flat(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:85
  def print_to_graph(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:91
  def print_to_graph_html(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:107
  def print_to_stack(options); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:103
  def print_to_tree(options); end

  # the name of the call stack profile file
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:70
  def stack_report; end

  # the name of the callgrind profile file
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:65
  def tree_report; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:119
  def validate_print_params(options); end

  class << self
    # @return [Boolean]
    #
    # source://ruby-prof-1.4.3/lib/ruby-prof/printers/multi_printer.rb:21
    def needs_dir?; end
  end
end
...
# source://ruby-prof-1.4.3/lib/ruby-prof/profile.rb:6
class RubyProf::Profile
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/profile.rb:23
  def exclude_common_methods!; end

  def exclude_method!(_arg0, _arg1); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/profile.rb:27
  def exclude_methods!(mod, *method_or_methods); end

  # source://ruby-prof-1.4.3/lib/ruby-prof/profile.rb:33
  def exclude_singleton_methods!(mod, *method_or_methods); end

  def measure_mode; end

  # source://ruby-prof-1.4.3/lib/ruby-prof/profile.rb:8
...
# source://ruby-prof-1.4.3/lib/ruby-prof/thread.rb:2
class RubyProf::Thread
  ...
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/thread.rb:4
  def total_time; end

  # Returns the amount of time this thread waited while other thread executed.
  #
  # source://ruby-prof-1.4.3/lib/ruby-prof/thread.rb:9
  def wait_time; end
end

# source://ruby-prof-1.4.3/lib/ruby-prof/version.rb:2
