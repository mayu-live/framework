...
class IO::Event::Interrupt
  ...
  # source://io-event//lib/io/event/interrupt.rb#34
  def close; end
...
class IO::Event::Selector::Select
  ...
  # @return [Boolean]
  #
  # source://io-event//lib/io/event/selector/select.rb#140
  def again?(errno); end
  ...
  # source://io-event//lib/io/event/selector/select.rb#273
  ...
  # source://io-event//lib/io/event/selector/select.rb#292
  def select(duration = T.unsafe(nil)); end
  ...
  # source://io-event//lib/io/event/selector/select.rb#279
  def pop_ready; end
end
