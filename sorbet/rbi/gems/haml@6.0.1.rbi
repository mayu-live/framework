...
class Haml::Compiler::ChildrenCompiler
  ...
  # source://haml//lib/haml/compiler/children_compiler.rb#11
  def compile(node, &block); end

  private

  # source://haml//lib/haml/compiler/children_compiler.rb#59
  def confirm_whitespace(temple); end

  # source://haml//lib/haml/compiler/children_compiler.rb#28
  def insert_newlines!(temple, node); end

  # @return [Boolean]
  #
  # source://haml//lib/haml/compiler/children_compiler.rb#108
  def insert_whitespace?(node); end

  # source://haml//lib/haml/compiler/children_compiler.rb#36
  def moving_lineno(node, &block); end

  # @return [Boolean]
  #
  # source://haml//lib/haml/compiler/children_compiler.rb#75
  def nuke_inner_whitespace?(node); end

  # @return [Boolean]
  #
  # source://haml//lib/haml/compiler/children_compiler.rb#97
  def nuke_outer_whitespace?(node); end

  # @return [Boolean]
  #
  # source://haml//lib/haml/compiler/children_compiler.rb#86
  def nuke_prev_whitespace?(node); end

  # @return [Boolean]
  #
  # source://haml//lib/haml/compiler/children_compiler.rb#70
  def prepend_whitespace?(node); end

  # source://haml//lib/haml/compiler/children_compiler.rb#102
...
class Haml::Compiler::ScriptCompiler
  ...
  # source://haml//lib/haml/compiler/script_compiler.rb#111
  def escape_html(temple); end

  # source://haml//lib/haml/compiler/script_compiler.rb#107
...
# source://haml//lib/haml/engine.rb#12
...
# source://haml//lib/haml/escapable.rb#5
class Haml::Escapable < ::Temple::Filters::Escapable
...
#
# source://haml//lib/haml/force_escapable.rb#6
module Haml::FescapeDispathcer
  # source://haml//lib/haml/force_escapable.rb#7
...
class Haml::Filters::TiltBase < ::Haml::Filters::Base
  # @return [Boolean]
  #
  # source://haml//lib/haml/filters/tilt_base.rb#13
  def explicit_require?(needed_registration); end

  private

  # source://haml//lib/haml/filters/tilt_base.rb#20
  def compile_with_tilt(node, name, indent_width: T.unsafe(nil)); end

  # source://haml//lib/haml/filters/tilt_base.rb#36
  def dynamic_compile(node, name, indent_width: T.unsafe(nil)); end

  # source://haml//lib/haml/filters/tilt_base.rb#28
...
#
# source://haml//lib/haml/force_escapable.rb#14
class Haml::ForceEscapable < ::Haml::Escapable
  # @return [ForceEscapable] a new instance of ForceEscapable
  #
  # source://haml//lib/haml/force_escapable.rb#15
  def initialize(opts = T.unsafe(nil)); end

  # ForceEscapable doesn't touch :escape expression.
  # This method is not used if it's inserted after Haml::Escapable.
  #
  # source://haml//lib/haml/force_escapable.rb#25
...
module Haml::ObjectRef
  class << self
    ...
    #
    # source://haml//lib/haml/object_ref.rb#19
...
class Haml::Parser::ParseNode < ::Struct
  ...
  # source://syntax_tree-haml/1.3.2/lib/syntax_tree/haml.rb#60
  ...
  # source://syntax_tree-haml/1.3.2/lib/syntax_tree/haml.rb#83
  def format(q); end
  ...
  # source://syntax_tree-haml/1.3.2/lib/syntax_tree/haml.rb#87
...
# source://haml//lib/haml/string_splitter.rb#6
module Haml::StringSplitter
  class << self
    # `code` param must be valid string literal
    #
    # source://haml//lib/haml/string_splitter.rb#8
...
class Haml::TempleEngine < ::Haml::Engine
  # source://haml//lib/haml/engine.rb#45
  def compile(template); end

  # source://haml//lib/haml/engine.rb#49
