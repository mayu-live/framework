...
class Mustermann::AST::Translator::NodeTranslator < Anonymous_Delegator_7
...
class Mustermann::Caster < Anonymous_Delegator_8
  def cast(hash); end
...
class InvalidName___Class_0x00___NodeTranslator_9 < Mustermann::AST::Translator::NodeTranslator
  def self.translator; end
end
