...
# source://console//lib/console/serialized/logger.rb#13
module Console::Serialized; end

# source://console//lib/console/serialized/logger.rb#14
class Console::Serialized::Logger
  ...
  # source://console//lib/console/serialized/logger.rb#34
  ...
  #
  # source://console//lib/console/serialized/logger.rb#22
  def io; end

  # Returns the value of attribute start.
  #
  # source://console//lib/console/serialized/logger.rb#23
  def start; end
  ...
  # source://console//lib/console/serialized/logger.rb#80
  ...
  # source://console//lib/console/serialized/logger.rb#84
...
module Console::Terminal
  class << self
    ...
    #
    # source://console//lib/console/terminal/logger.rb#22
...
#
# source://console//lib/console/terminal/logger.rb#19
Console::Terminal::CONSOLE_START_AT = T.let(T.unsafe(nil), String)

# source://console//lib/console/terminal/logger.rb#43
class Console::Terminal::Logger
  # @return [Logger] a new instance of Logger
  #
  # source://console//lib/console/terminal/logger.rb#44
  ...
  # Returns the value of attribute io.
  #
  # source://console//lib/console/terminal/logger.rb#67
  def io; end

  # source://console//lib/console/terminal/logger.rb#78
  def register_defaults(terminal); end

  # Returns the value of attribute start.
  #
  # source://console//lib/console/terminal/logger.rb#71
  def start; end
  ...
  # Returns the value of attribute verbose.
  #
  # source://console//lib/console/terminal/logger.rb#69
  def verbose; end
  ...
  # source://console//lib/console/terminal/logger.rb#189
  def build_prefix(name); end

  # source://console//lib/console/terminal/logger.rb#143
  def default_suffix(object = T.unsafe(nil)); end

  # source://console//lib/console/terminal/logger.rb#122
  def format_argument(argument, output); end

  # source://console//lib/console/terminal/logger.rb#153
  def format_object_subject(severity, prefix, subject, output); end

  # source://console//lib/console/terminal/logger.rb#118
  def format_options(options, output); end

  # source://console//lib/console/terminal/logger.rb#165
  def format_string_subject(severity, prefix, subject, output); end

  # source://console//lib/console/terminal/logger.rb#133
  def format_subject(severity, prefix, subject, buffer); end

  # source://console//lib/console/terminal/logger.rb#177
  def format_value(value, output); end

  # source://console//lib/console/terminal/logger.rb#185
