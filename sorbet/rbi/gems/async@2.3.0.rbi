...
# source://async//lib/async/list.rb#6
module Async; end
...
class Async::Scheduler < ::Async::Node
  ...
  # source://async//lib/async/scheduler.rb#144
  ...
  #
  # source://async//lib/async/scheduler.rb#252
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/scheduler.rb#63
  def closed?; end
  ...
  # source://async//lib/async/scheduler.rb#170
  ...
  # source://async//lib/async/scheduler.rb#174
  def io_write(io, buffer, length, offset = T.unsafe(nil)); end

  # source://async//lib/async/scheduler.rb#135
  ...
  # source://async//lib/async/scheduler.rb#288
...
class Async::Semaphore
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/semaphore.rb#37
  def blocking?; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/semaphore.rb#32
  def empty?; end
  ...
  #
  # source://async//lib/async/semaphore.rb#100
  def wait; end
end

# source://async//lib/async/semaphore.rb#85
class Async::Semaphore::FiberNode < ::Async::List::Node
  # @return [FiberNode] a new instance of FiberNode
  #
  # source://async//lib/async/semaphore.rb#86
  def initialize(fiber); end
...
class Async::Task < ::Async::Node
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#213
  def complete?; end

  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#189
  def current?; end
  ...
  #
  # source://async//lib/async/task.rb#147
  def result; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#209
  def stopped?; end
  ...
  #
  # source://async//lib/async/task.rb#281
  def set!; end
  ...
  class << self
    ...
    #
    # source://async//lib/async/task.rb#179
    def current; end
...
# source://async//lib/async/variable.rb#9
class Async::Variable
  ...
  # source://async//lib/async/variable.rb#15
  def resolve(value = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://async//lib/async/variable.rb#25
  def resolved?; end

  # source://async//lib/async/variable.rb#29
  def value; end

  # source://async//lib/async/variable.rb#34
  def wait; end
end
