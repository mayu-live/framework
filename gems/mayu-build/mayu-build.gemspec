...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "klenod-build", "= 0.0.22"
  spec.add_dependency "klenod-test", "= 0.0.22"
  spec.add_dependency "klenod-lsp", "= 0.0.22"
  spec.add_dependency "klenod-plugin-css", "= 0.0.22"
  spec.add_dependency "klenod-plugin-javascript", "= 0.0.22"
