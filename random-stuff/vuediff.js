...
function updateChildren(
  ...
  while (oldStartIdx <= oldEndIdx && newStartIdx <= newEndIdx) {
    if (isUndef(oldStartVnode)) {
      ...
      canMove &&
        nodeOps.insertAfter( parentElm, oldStartVnode, oldEndVnode);
      oldStartVnode = oldCh[++oldStartIdx]
      newEndVnode = newCh[--newEndIdx]
...
function addVnodes(
  ...
  console.log('adding vnodes', newStartIdx, newEndIdx, newCh.slice(newStartIdx, newEndIdx + 1))
}

function removeVnodes(oldCh, oldStartIdx, oldEndIdx) {
  console.log('removing vnodes', oldStartIdx, oldEndIdx, oldCh.slice(oldStartIdx, oldEndIdx + 1))
}
